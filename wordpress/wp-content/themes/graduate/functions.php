...
function graduate_scripts() {
	...
	// jquery sidr
	wp_enqueue_script( 'jquery-sidr', get_template_directory_uri() . '/assets/plugins/js/jquery.sidr.min.js', array(), '', true );

	// jquery slick
	wp_enqueue_script( 'jquery-slick', get_template_directory_uri() . '/assets/plugins/js/slick.min.js', array(), '', true );

	if ( $graduate_animation === true ) {
		// jquery wow
		wp_enqueue_script( 'jquery-wow', get_template_directory_uri() . '/assets/plugins/js/wow.min.js', array(), '', true );
